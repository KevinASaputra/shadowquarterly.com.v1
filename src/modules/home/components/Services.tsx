    ...
    <section className='space-y-5'>
      <div className='space-y-3'>
        ...
        <p className='leading-[1.8] md:leading-loose text-neutral-800 dark:text-neutral-300'>
          What I'm working on
          I help brands, companies, institutions, and startups create exceptional digital experiences for their businesses through strategic development services. I am also exploring a market algorithm to create a technical analysis that is more suitable for use by many people, retailers, and even institutional traders.
        </p>
      </div>
