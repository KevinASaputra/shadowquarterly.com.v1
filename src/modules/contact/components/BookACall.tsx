...
const BookACall = () => {
  return (
    <div className='space-y-5 pb-2'>
      <h3 className='text-lg font-medium'>Book a Mentorship Trading</h3>
      <Link
        href='https://whop.com/shadow-quarterly'
        target='_blank'
      ...
      >
        <div className='flex gap-5 items-start justify-between'>
          <div className='space-y-1'>
            <div className='flex items-center gap-2 text-base md:text-lg font-medium'>
              <span>Private Group Community</span>
            </div>
            <p className='dark:text-neutral-300 text-sm md:text-base'>
              How To Analyst Market Using Logic And Realistist Market Algorithm
            </p>
          </div>
        ...
        <div className='flex items-center gap-5 dark:text-neutral-200 text-sm'>
          <div className='flex items-center gap-2'>
            <FiClock size={18} />
            <span>6 Month Private Mentoship Lika a study in campuss</span>
          </div>
          <div className='flex items-center gap-2'>
            <FiVideo size={18} />
            <span>Whoop.com / Telegram Private Group</span>
          </div>
        </div>
      </Link>
    </div>
